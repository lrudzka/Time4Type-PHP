<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        if ($everythingOk == true)
        {
            ...
            $queryCheck = $db->prepare('SELECT * FROM types_users WHERE login=:login');
        ...
        if ($everythingOk == true)
        {
            //insert z użyciem PDO
                ...
                $query = $db->prepare('INSERT INTO types_users VALUES (:login, :password, :email)');
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-6">
                        <?php
                            ...
                            {
                                echo '<span class="wrongData"><strong>'.$_SESSION['e_login'].'</strong></span>';
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-10">
                        <?php
                            ...
                            {
                                echo '<br/><span class="wrongData"><strong>'.$_SESSION['e_bot'].'</strong></span>';
